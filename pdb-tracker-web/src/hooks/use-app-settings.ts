...
export const ALL_ACTIVITY_TYPES = [
  { id: 'new_entry', label: 'New PDB Entry', icon: '🧬' },
  { id: 'weekly_report', label: 'Weekly Report', icon: '📊' },
  { id: 'evaluation_update', label: 'Evaluation Update', icon: '🔬' },
  { id: 'literature_update', label: 'Literature Update', icon: '📄' },
] as const;
