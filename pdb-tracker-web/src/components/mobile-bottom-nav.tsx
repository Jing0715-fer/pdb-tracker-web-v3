    ...
    <>
      <nav className="mobile-bottom-nav sm:hidden no-print" aria-label="Mobile navigation">
        ...
        <button
          ...
          onClick={() => { setAdvancedFiltersOpen(prev => !prev); setMobileMoreMenuOpen(false); }}
          aria-label="Filters"
        >
        ...
        <button
          ...
          onClick={() => { setShowBookmarksOnly(prev => !prev); if (showBookmarksOnly) setActiveCollection(null); setMobileMoreMenuOpen(false); }}
