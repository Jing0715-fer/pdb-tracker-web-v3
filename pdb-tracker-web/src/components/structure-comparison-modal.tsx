            ...
            <div className="flex-1 overflow-y-auto px-5 py-4 custom-scrollbar space-y-2.5">
              ...
              {(leftEntry.authors || rightEntry.authors) && (
                <ComparisonField
                  ...
                  diffLeft={compareText(leftEntry.authors, rightEntry.authors) === 'same' ? 'same' : 'different'}
                  diffRight={compareText(leftEntry.authors, rightEntry.authors) === 'same' ? 'same' : 'different'}
                />
              )}
