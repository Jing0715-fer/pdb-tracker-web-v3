...
import { FlaskConical, Search, ArrowRight, Database } from 'lucide-react';
...
function EmptyState() {
  return (
    <EnhancedEmptyState
      ...
      accentColor="#c96442"
      suggestions={[
        { icon: '🧬', text: 'Choose an evaluation' },
        { icon: '📊', text: 'View quality scores' },
        { icon: '🔬', text: 'Explore BLAST results' },
      ]}
    />
  );
}
